...
public class FirmwareEventLog {
    ...
    private static final String TAG = "FirmwareEventLog";
    private static Map<String, EventInfo> eventMap = new HashMap<>();

    public static List<EventFila> leerFirmwareEventLog(Context context, GXDLMSReader reader, String from, String to) {
        ...
        try {
            ...
            AppLogger.i(TAG, "Leyendo estructura de Firmware Event Log...");
            reader.read(firmwareLog, 3);
            ...
            AppLogger.i(TAG, "Solicitando eventos de firmware...");
            ...
            if (rows != null && rows.length > 0) {
                ...
                AppLogger.i(TAG, "No hay eventos de firmware registrados.");
            }
        } catch (Exception e) {
            AppLogger.e(TAG, "Error en Firmware Log: " + e.getMessage());
        }
        return result;
    }
