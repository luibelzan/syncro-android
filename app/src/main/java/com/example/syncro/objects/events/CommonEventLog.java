...
public class CommonEventLog {
    ...
    public static List<EventFila> leerCommonEventLog(Context context, GXDLMSReader reader, String from, String to) {
        ...
        try {
            ...
            AppLogger.i(TAG, "Leyendo estructura de Common Event Log...");
            reader.read(commonLog, 3);
            ...
            AppLogger.i(TAG, "Solicitando eventos comunes...");
            ...
            if (rows != null && rows.length > 0) {
                ...
                for (Object row : rows) {
                    ...
                    EventDescription info = getEventDescription(context, id, 6);
