...
public class StandarEventLogReader {
    ...
    private static final String TAG = "StandarEventLogReader";
    ...
    public static List<EventFila> readStandardEventLog(Context context, GXDLMSReader reader, String from, String to) {
        ...
        try {
            ...
            AppLogger.i(TAG, "Leyendo estructura de Standard Event Log...");
            reader.read(eventLog, 3);
            ...
            AppLogger.i(TAG, "Solicitando eventos desde " + from + " hasta " + to);
            ...
            AppLogger.e(TAG, "Error leyendo logs: " + e.getMessage());
        }
        return result;
    }
