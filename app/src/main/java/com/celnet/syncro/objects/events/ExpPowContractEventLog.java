...
public class ExpPowContractEventLog {
    ...
    private static final String TAG = "ExpPowContractEventLog";
    private static Map<String, EventInfo> eventMap = new HashMap<>();

    public static List<EventFila> readExpPowContractEventLog(Context context, GXDLMSReader reader, String from, String to) {
        ...
        try {
            ...
            AppLogger.i(TAG, "Leyendo estructura de Export Power Contract Event Log...");
            reader.read(expPowLog, 3);

            if (expPowLog.getCaptureObjects() == null || expPowLog.getCaptureObjects().isEmpty()) {
                ...
                expPowLog.getCaptureObjects().add(new java.util.AbstractMap.SimpleEntry<>(clock, capClock));
                expPowLog.getCaptureObjects().add(new java.util.AbstractMap.SimpleEntry<>(eventCode, capEvent));
            }
            ...
            AppLogger.i(TAG, "Solicitando eventos de exportación de potencia...");
            ...
            if (rows != null && rows.length > 0) {
                ...
                AppLogger.i(TAG, "No se registraron cambios en el contrato de exportación.");
            }
        } catch (Exception e) {
            AppLogger.e(TAG, "Error en Exp Pow Contract Log: " + e.getMessage());
        }
        return result;
    }
