...
public class DemandMgmntEventLog {
    ...
    private static final String TAG = "DemandMgmntEventLog";
    private static Map<String, EventInfo> eventMap = new HashMap<>();

    public static List<EventFila> readDemandMgmntEventLog(Context context, GXDLMSReader reader, String from, String to) {
        ...
        try {
            ...
            AppLogger.i(TAG, "Leyendo estructura de Demand Management Event Log...");
            reader.read(demandLog, 3);

            if (demandLog.getCaptureObjects() == null || demandLog.getCaptureObjects().isEmpty()) {
                ...
                demandLog.getCaptureObjects().add(new java.util.AbstractMap.SimpleEntry<>(clock, capClock));
                demandLog.getCaptureObjects().add(new java.util.AbstractMap.SimpleEntry<>(eventCode, capEvent));
            }
            ...
            AppLogger.i(TAG, "Solicitando eventos de gestión de demanda...");
            ...
            if (rows != null && rows.length > 0) {
                ...
                for (Object row : rows) {
                    ...
                    EventDescription info = getEventDescription(context, id, 5);
                ...
                AppLogger.i(TAG, "No hay eventos de gestión de demanda registrados.");
            }
        } catch (Exception e) {
            AppLogger.e(TAG, "Error en Demand Mgmnt Log: " + e.getMessage());
        }
        return result;
    }
